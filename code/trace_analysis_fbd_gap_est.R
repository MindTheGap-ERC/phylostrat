...
if (!dir.exists("figs/fbd_gap_est")) {
  dir.create("figs/fbd_gap_est", recursive = TRUE)
}
...
fig
ggsave("figs/fbd_gap_est/fbd_gap_est_summary.png", plot = fig)
...
ggsave("figs/fbd_gap_est/fbd_gap_est_psi.png")
